...
import static com.vodafone.charging.mock.IFSoapResponseDataBuilder.aSoapCancelResponse;
...
public class WiremockPreparer extends WiremockDefaultPreparer {
    ...
    public static StubMapping prepareForPaymentAuth(ChargingId chargingId,
                                                    String xPath,
                                                    String response) {
    ...
    public static StubMapping prepareForPaymentAuth(String msisdn,
                                                    String xPath,
                                                    String response) {
        ...
        return stubFor(post(urlEqualTo(IF_TEST_URL))
                        .withRequestBody(matchingXPath(xPath)
                                .withXPathNamespace(SOAP_NS.prefix(), SOAP_NS.url())
                                .withXPathNamespace(VODAFONE_NS.prefix(), VODAFONE_NS.url()))
                        .withRequestBody(containing(msisdn))
                        .willReturn(aResponse()
                                .withStatus(SC_OK)
                                .withBody(response))
        );
    ...
    public static StubMapping prepareForCapture(ChargingId chargingId,
                                                String xPath,
                                                String response) {
    ...
    public static StubMapping prepareForRefund(ChargingId chargingId,
                                               String xPath,
                                               String response) {
    ...
    public static StubMapping prepareForNotification(ChargingId chargingId,
            String xPath,
            String response) {
    ...
    public static StubMapping prepareForRemainingBalance(ChargingId chargingId,
    		String xPath,
    		String response) {
    	return stubFor(post(urlEqualTo(IF_TEST_URL))
    			.withHeader(REQUEST_CHARGING_ID_HEADER_NAME, equalTo(chargingId.toString()))
