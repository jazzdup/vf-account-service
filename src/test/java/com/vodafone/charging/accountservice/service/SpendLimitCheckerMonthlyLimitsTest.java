...
public class SpendLimitCheckerMonthlyLimitsTest extends SpendLimitCheckerBase {
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitDefinedDefaultsDefinedPaymentsOverLimitRefundsLowerTotalToEqualLimit() {
        //given
...
//        BigDecimal currentTransactionAmount = new BigDecimal(0.3);
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitAndDefaultAndBillingCycleDayDefinedPaymentsOverLimitRefundsLowerTotalToEqualLimit() {
    ...
    @Test
    public void shouldBreachWhenMonthLimitAndDefaultDefinedPaymentsOverLimitRefundsLowerTotalToBelowLimitThenCurrentTxOverLimit() {
        //given
...
//        BigDecimal currentTransactionAmount = new BigDecimal(0.4);
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitDefaultDefinedPaymentsOverLimitRefundsLowerTotalToBelowLimit() {
        //given
        //payments=65.5, refunds 15.8, currentTx 0.3 total 50 - month spend limit = 50
        final List<ERTransaction> transactions =
                anERTransactionListWithinDates(monthDates.get("startDate"), monthDates.get("endDate"));

        final PaymentContext paymentContext = aPaymentContext(SpendLimitInfo.from(defaultSpendLimits), new BigDecimal(0.2));
        double totalTxValue = 49.90;
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitAndDefaultAndBillingCycleDayDefinedPaymentsOverLimitRefundsLowerTotalToBelowLimit() {
        ...
        PaymentContext paymentContext = aPaymentContext(SpendLimitInfo.from(defaultSpendLimits), new BigDecimal(0.2));
        ...
        assertThat(result.getFailureReason()).isEmpty();
        assertThat(result.getAppliedLimitValue()).isEqualTo(spendLimits.get(2).getLimit().doubleValue());
        assertThat(result.getTotalTransactionsValue()).isEqualTo(49.9);
...
//        BigDecimal currentTransactionAmount = new BigDecimal(5.4);
    ...
    @Test
    public void shouldNotBreachDefaultWhenNoMonthLimitDefinedButDefaultIsAndPaymentsAreEqualToLimit() {

        //given
        //payments=65.5, refunds 15.8, currentTx 5.3 - month spend limit = 55
        final List<ERTransaction> transactions =
                anERTransactionListWithinDates(monthDates.get("startDate"), monthDates.get("endDate"));

        PaymentContext paymentContext = aPaymentContext(SpendLimitInfo.from(defaultSpendLimits), new BigDecimal(5.3));
        double totalTxValue = 55.0;
    ...
    @Test
    public void shouldNotBreachWhenDefaultAndBillingCycleDayDefinedNoMonthLimitDefinedAndPaymentsAreEqualToDefault() {
        //given
        Map<String, LocalDateTime> billingCycleDates = getBillingCycleDates(10);
        String startKey = "startDate";
        String endKey = "endDate";
    ...
    @Test
    public void shouldNotBreachDefaultWhenNoMonthLimitDefinedButDefaultIsAndPaymentsAreBelowLimit() {
        ...
        PaymentContext paymentContext = aPaymentContext(SpendLimitInfo.from(defaultSpendLimits), new BigDecimal(5.2));
        double totalTxValue = 54.9;
    ...
    @Test
    public void shouldNotBreachWhenDefaultAndBillingCycleDayDefinedNoMonthLimitDefinedAndPaymentsAreBelowDefault() {
        //given
        Map<String, LocalDateTime> billingCycleDates = getBillingCycleDates(10);
        String startKey = "startDate";
        String endKey = "endDate";
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitDefinedButNoDefaultAndPaymentsEqualToLimit() {
        //given
        //payments=65.5, refunds 15.8, currentTx 0.3 total 50 - month spend limit = 50
        final List<ERTransaction> transactions =
                anERTransactionListWithinDates(monthDates.get("startDate"), monthDates.get("endDate"));

        final PaymentContext paymentContext = aPaymentContext(Collections.emptyList(), new BigDecimal(0.3));
        double totalTxValue = 50.00;
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitAndBillingCycleDayDefinedButNoDefaultAndPaymentsEqualToLimit() {
        //given
        Map<String, LocalDateTime> billingCycleDates = getBillingCycleDates(10);
        String startKey = "startDate";
        String endKey = "endDate";
        ...
        PaymentContext paymentContext = aPaymentContext(Collections.emptyList(), new BigDecimal(0.3));
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitDefinedButNoDefaultAndPaymentsBelowLimit() {
        //given
        //payments=65.5, refunds 15.8, currentTx 0.3 total 50 - month spend limit = 50
        final List<ERTransaction> transactions =
                anERTransactionListWithinDates(monthDates.get("startDate"), monthDates.get("endDate"));

        final PaymentContext paymentContext = aPaymentContext(Collections.emptyList(), new BigDecimal(0.2));
        double totalTxValue = 49.90;
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitAndBillingCycleDayDefinedButNoDefaultAndPaymentsBelowLimit() {
        //given
        Map<String, LocalDateTime> billingCycleDates = getBillingCycleDates(10);
        String startKey = "startDate";
        String endKey = "endDate";
        ...
        PaymentContext paymentContext = aPaymentContext(Collections.emptyList(), new BigDecimal(0.2));
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitDefinedButNoDefaultAndPaymentsOverLimit() {
        ...
        final PaymentContext paymentContext = aPaymentContext(Collections.emptyList(), new BigDecimal(0.4));
//        BigDecimal currentTransactionAmount = new BigDecimal(0.4);
        double totalTxValue = 50.1;
    ...
    @Test
    public void shouldNotBreachWhenMonthLimitAndBillingCycleDayDefinedButNoDefaultAndPaymentsOverLimit() {
        //given
        Map<String, LocalDateTime> billingCycleDates = getBillingCycleDates(10);
        String startKey = "startDate";
        String endKey = "endDate";
        ...
        //payments=65.5, refunds 15.8, currentTx = 0.4 total 50.1 - month spend limit = 50
        final List<ERTransaction> transactions = anERTransactionListWithinDates(billingCycleDates.get(startKey), billingCycleDates.get(endKey));
        PaymentContext paymentContext = aPaymentContext(Collections.emptyList(), new BigDecimal(0.4));
//        BigDecimal currentTransactionAmount = new BigDecimal(0.4);
    ...
    @Test
    public void shouldNotBreachMonthlyLimitsIfNoLimitsSet() {
