 ...
 * with the corresponding {@link com.vodafone.charging.accountservice.domain.enums.ResponseStatus} (ACCEPTED, DENIED, REJECTED, ERROR),
...
public enum ResponseType {
    ...
    /**
     * KYC success would be verification_not_required|verified, KYC failed would be not-verified|in-progress|rejected;
     */
    ...
    ResponseType(ResponseStatus status) {
        this.status = status;
    }
     ...
     *
     * @return a {@link ResponseStatus} object.
     */
     ...
     *
     * @param response a {@link ERIFResponse} object.
     * @return a boolean.
     */
     ...
     * @return a {@link String} object.
     */
    public static String getStatusStr(String type) {
